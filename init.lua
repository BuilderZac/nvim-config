...
require("lazy").setup({
	...
	{ -- Fuzzy Finder (files, lsp, etc)
		...
		dependencies = {
			...
			{ "nvim-tree/nvim-web-devicons" }, -- modded
		},
		config = function()
		...
		config = function()
			...
			cmp.setup({
				...
				mapping = cmp.mapping.preset.insert({
					...
					--["<C-j>"] = cmp.mapping.select_next_item(), -- modded
					-- Select the [p]revious item
					--["<C-k>"] = cmp.mapping.select_prev_item(), -- modded
					...
					["<Tab>"] = cmp.mapping.confirm({ select = true }), -- modded
	...
	{ -- You can easily change to a different colorscheme.
		...
		init = function()
			...
			vim.cmd.colorscheme("molokai") -- modded
	...
	{ -- Collection of various small independent plugins/modules
		...
		config = function()
			...
			-- local statusline = require("mini.statusline") modded
			-- set use_icons to true if you have a Nerd Font
			-- statusline.setup({ use_icons = vim.g.have_nerd_font }) modded

			-- You can configure sections in the statusline by overriding their
			-- default behavior. For example, here we set the section for
			-- cursor location to LINE:COLUMN
			---@diagnostic disable-next-line: duplicate-set-field
			-- statusline.section_location = function() modded
			--	return "%2l:%-2v" modded
			-- end modded
