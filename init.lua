...
-- Modified single lines will end with a comment saying "modded"
...
do
	...
	vim.g.have_nerd_font = true -- modded
	...
	vim.o.relativenumber = true -- modded
...
do
	...
	vim.pack.add({ { src = gh("preservim/nerdtree") } })
  ...
  vim.api.nvim_create_autocmd("BufEnter", {
	...
	vim.pack.add({ { src = gh("sakhnik/nvim-gdb") } })

	vim.pack.add({ { src = gh("mg979/vim-visual-multi") } })
	...
	vim.api.nvim_create_autocmd("VimEnter", {
		callback = function()
			require("dashboard").setup({
				theme = "hyper",
				config = {
					footer = { "Keep moving like no one is looking" },
					week_header = {
						enable = true,
					},
					shortcut = {
	...
	vim.pack.add({ { src = gh("seandewar/nvimesweeper") } })
...
do
	...
	local parsers =
		{ "bash", "c", "diff", "html", "lua", "yaml", "luadoc", "markdown", "markdown_inline", "query", "vim", "vimdoc"}
